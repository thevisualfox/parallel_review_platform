(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var injectElement = function injectElement(el, evalScripts, renumerateIRIElements, cacheRequests, beforeEach, callback) {
      ...
      loadSvg(elUrl, function (error, svg) {
        if (!svg) {
          injectedElements.splice(injectedElements.indexOf(el), 1);
          el = null;
          callback(error);
        ...
        var mergedClasses = Array.from(new Set(__spreadArray(__spreadArray(__spreadArray([], (svg.getAttribute('class') || '').split(' ')), ['injected-svg']), (el.getAttribute('class') || '').split(' ')))).join(' ').trim();
